...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'price'                           => 'valor',
        'price_promotional'               => 'valor promocional',
        ...
        'user_id'                         => 'Usuário',
        'salespeople_id'                  => 'Vendedor ',
        'groups_ids'                      => 'Grupo',
        'identifier_code'                 => 'Número de Identificação',
        'operator_id'                     => 'Operadora',
        'type_insert'                     => 'Tipo de Inserção',
        'full_name'                       => 'Nome completo',
        'bank_id'                         => 'Instituição Bancária',
        'unity_id'                        => 'Unidade',
        'agency'                          => 'Agência Bancária',
        'number_account'                  => 'Conta Bancária',
        'value'                           => 'Valor',
        "docNumber"                       => "Campo Número do documento é obrigatório",
        "docType"                         => "Campo Tipo do documento é obrigatório",
        "email"                           => "E-mail",
        "cardExpirationMonth"             => " Mês de validade",
        "cardExpirationYear"              => "Ano de Validade",
        "cardNumber"                      => "Número do Cartão",
        "securityCode"                    => "Código de segurança",
        "cardholderName"                  => "Títular do Cartão",
        "document_number"                 => "CPF ou CNPJ",
        "installments"                    => "Quantidade de Parcelas",
        "issuer"                          => "Banco Emissor",
        "due_date"                        => "Data de Vencimento",
        "balanceAtTheTimeOfCreate"        => "Saldo no Momento da Criação",
        "sender_id"                       => "Quem está enviando",
        "receiver_id"                     => "Quem está recebendo",
